...
<head>
  ...
  <link href="<?php bloginfo('template_url');?>/images/logo-whiteback.png" rel="shortcut icon" type="image/x-icon">
  <link href="<?php bloginfo('template_url');?>/images/logo-whiteback.png" rel="apple-touch-icon">
  <?php wp_head(); ?>
</head>
<body class="body">